---
layout: post
title: "Introducing the PubID initiative"
date: 2023-09-05
...
excerpt: >-
  The PubID initiative is the , the latest human-readable
  publication identifier syntax at NIST, and the effort behind to migrate
...
ISBN is a great example. The ISBN (International Standard Book Number) is
amongst a family of identifiers created by
https://www.iso.org/committee/48750.html[ISO/TC 46],
it provides a unique number for every title.
The ISBN number is a numeric identifier of 10- or 13-digits, such as
`978-0691097503` (ISBN-13) or `069109750X` (ISBN-10).

The DOI (Digital Object Identifier) is another identification scheme (also by
https://www.iso.org/committee/48750.html[ISO/TC 46])
that is commonly used for digital publications because of its PURL
