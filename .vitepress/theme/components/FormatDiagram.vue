...
const examples: FormatExample[] = [
  {
    ...
    publisher: 'ISO',
    components: [
      { key: 'Publisher', value: 'ISO', color: '#2563eb' },
      { key: 'Number', value: '9001', color: '#e11d48' },
      { key: 'Year', value: '2015', color: '#d97706' },
      { key: 'Edition', value: '5', color: '#059669' },
    ],
    outputs: [
      { label: 'Human-Readable', abbr: 'PubID', value: 'ISO 9001:2015', accent: '#2563eb' },
      { label: 'Short', abbr: 'Short', value: 'ISO 9001', accent: '#059669' },
      { label: 'Machine-Readable', abbr: 'MR', value: 'ISO 9001:2015', accent: '#7c3aed' },
  ...
  },
  {
    ...
    publisher: 'NIST',
    components: [
      { key: 'Publisher', value: 'NIST', color: '#2563eb' },
      { key: 'Type', value: 'SP', color: '#059669' },
      { key: 'Number', value: '800-53', color: '#e11d48' },
      { key: 'Revision', value: '5', color: '#7c3aed' },
    ],
    outputs: [
      { label: 'Full (Long)', abbr: 'Full', value: 'National Institute of Standards and Technology Special Publication 800-53 Revision 5', accent: '#2563eb' },
      { label: 'Abbreviated', abbr: 'Abbr', value: 'Natl. Inst. Stand. Technol. Spec. Publ. 800-53 Rev. 5', accent: '#059669' },
      { label: 'Short', abbr: 'Short', value: 'NIST SP 800-53 Rev. 5', accent: '#7c3aed' },
  ...
  },
  {
    ...
    publisher: 'ISO/IEC',
    components: [
      { key: 'Publisher', value: 'ISO/IEC', color: '#2563eb' },
      { key: 'Number', value: '17031-1', color: '#e11d48' },
      { key: 'Year', value: '2020', color: '#d97706' },
      { key: 'Supplement', value: 'Amd 1:2022', color: '#0d9488' },
    ],
    outputs: [
      { label: 'Human-Readable', abbr: 'PubID', value: 'ISO/IEC 17031-1:2020/Amd 1:2022', accent: '#2563eb' },
      { label: 'Short', abbr: 'Short', value: 'ISO/IEC 17031-1/Amd 1', accent: '#059669' },
      { label: 'Machine-Readable', abbr: 'MR', value: 'ISO/IEC 17031-1:2020/Amd 1:2022', accent: '#7c3aed' },
