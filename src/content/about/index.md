...
Since then, PubID has grown to cover **35+ publishers** across international, regional, national, and industry standards, with a Ruby reference implementation that parses, renders, and interchanges identifiers with round-trip fidelity.
...
| **Publisher Schemas** | 35+ publisher-specific schema definitions |
